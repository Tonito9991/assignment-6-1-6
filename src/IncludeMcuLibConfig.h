...
#define McuWatchdog_CONFIG_REPORT_ID_INCLUDE_HEADER_FILE    "../../TSM_PicoW_Sensor/src/platform.h" /* path from McuLib/src/McuWatchdog.c to our platform.h */
#define McuWatchdog_CONFIG_REPORT_ID_INCLUDE_FILE           "../../TSM_PicoW_Sensor/src/McuWatchdog_IDs.inc" /* path from McuLib/src/McuWatchdog.c to our ID file */
...
/* ---------------------------------------------------------------------------------------*/
/* Mqtt_Sensor */
#define MQTT_SENSOR_CONFIG_TOPIC_NAME_SENSOR_ENABLE           "pico/sensor/enable"
#define MQTT_SENSOR_CONFIG_TOPIC_NAME_SENSOR_TEMPERATURE      "pico/sensor/temperature"
#define MQTT_SENSOR_CONFIG_TOPIC_NAME_SENSOR_HUMIDITY         "pico/sensor/humidity"
/* ---------------------------------------------------------------------------------------*/
/* Mqtt_Client */
#define MQTT_CLIENT_CONFIG_HEADER_FILE            "mqtt_sensor.h"
#define MQTT_CLIENT_INCOMING_PUBLISH_CALLBACK     MqttSensor_incoming_publish_cb
#define MQTT_CLIENT_INCOMING_DATA_CALLBACK        MqttSensor_incoming_data_cb
#define MQTT_CLIENT_CONNECTION_CALLBACK           MqttSensor_connection_cb
/* ---------------------------------------------------------------------------------------*/
